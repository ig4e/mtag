...
import { type SettingsState, useSettings } from "~/store/settings";
...
function Footer() {
  ...
  return (
    <>
      <footer
        className={cn(
          "fixed inset-x-0 bottom-0 z-40 border-t border-border bg-background/50 py-3 drop-shadow-md backdrop-blur-xl transition-all will-change-auto",
          {
            "translate-y-16":
              !show && ["footer", "all"].includes(settings.hideOnScroll),
          },
        )}
      >
          ...
          <Drawer>
            ...
            <DrawerContent>
              <DrawerHeader className="flex flex-col items-center">
                ...
                <DrawerDescription>
                  You can change the app settings here.
                </DrawerDescription>
              </DrawerHeader>
                ...
                <Tabs className="w-full" defaultValue="source">
                  ...
                  <TabsContent value="source" className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        onValueChange={(value) =>
                          settings.setSource(value as SettingsState["source"])
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        ...
                        onValueChange={(value) =>
                          settings.setMediaType(
                            value as SettingsState["mediaType"],
                          )
                        }
                    ...
                    <div
                      className="space-y-2"
                      hidden={!sourceSettings.categories.support}
                    >
                      ...
                      <div className="flex items-center gap-2">
                        {sourceSettings.categories.values ? (
                          <RSelect
                            ...
                            className="w-full"
                            isMulti
                            options={sourceSettings.categories.values.map(
                              (value) => ({ label: value, value }),
                            )}
                            value={settings.categories.map((value) => ({
                              label: value,
                              value,
                            }))}
                          ></RSelect>
                    ...
                    <div
                      className="space-y-2"
                      hidden={!sourceSettings.subs.support}
                    >
                      ...
                      <div className="flex items-center gap-2">
                        <RSelect
                          ...
                          className="w-full"
                          isMulti
                          options={sourceSettings.subs.values?.map((value) => ({
                            label: value,
                            value,
                          }))}
                          value={settings.categories.map((value) => ({
                      ...
                      <p className="text-sm text-muted-foreground">
                        When using Subs the following options are ignored: SFW,
                        Media Type
                      </p>
                    </div>
                  </TabsContent>
                  ...
                  <TabsContent value="settings" className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Select
                        onValueChange={(value) =>
                          settings.setHideOnScroll(
                            value as SettingsState["hideOnScroll"],
                          )
                        }
                    ...
                    <div className="space-y-2">
                      ...
                      <Select
                        onValueChange={(value) =>
                          settings.setBlurLevel(value as SettingsState["blur"])
                        }
                        value={settings.blur}
                      >
                        <SelectTrigger className="w-full">
                      ...
                      <div className="flex items-center justify-between gap-4 pt-2">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(value) =>
                            settings.setVideoOptimizations({ autoplay: value })
                          }
                        />
                      </div>
                      ...
                      <CollapsibleContent className="space-y-2">
                        <div className="flex items-center justify-between gap-4 pt-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(value) =>
                              settings.setVideoOptimizations({ muted: value })
                            }
                          />
                        </div>
                      </CollapsibleContent>
                    ...
                    <Collapsible>
                      ...
                      <div className="mb-2 flex items-center justify-between gap-4">
                        ...
                        <Switch
                          ...
                          onCheckedChange={(value) =>
                            settings.setImageOptimizations(value)
                          }
                        />
                      </div>

                      <div className="mb-2 flex items-center justify-between gap-4">
                        <Label htmlFor="image-optimizations">
                          Enabled in preview
                        </Label>
                        <Switch
                          checked={settings.imageOptimizations.enabledInPreview}
                          onCheckedChange={(value) =>
                            settings.setImageOptimizationsInPreview(value)
                          }
                        />
                      </div>
                      ...
                      <CollapsibleContent className="space-y-2">
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) =>
                              settings.setImageOptimizationQuailty(
                                Number(value),
                              )
                            }
                        ...
                        <div
                          className="space-y-2"
                          hidden={!settings.imageOptimizations.enabledInPreview}
                        >
                          <Label
                            htmlFor="image-optimizations"
                            className="text-sm"
                          ...
                          <Select
                            onValueChange={(value) =>
                              settings.setImageOptimizationQuailtyInPreview(
                                Number(value),
                              )
                            }
                            value={String(
                              settings.imageOptimizations.previewQuailty,
                            )}
                          >
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder="95%" />
                        ...
                        <div className="space-y-2">
                          ...
                          <Select
                            onValueChange={(value) =>
                              settings.setImageOptimizationSharpness(
                                Number(value),
                              )
                            }
                            value={String(
                              settings.imageOptimizations.sharpness,
                            )}
                          >
                            <SelectTrigger className="w-full">
                              <SelectValue placeholder="95%" />
                        ...
                        <div className="flex items-center justify-between gap-4 pt-2">
                          ...
                          <Switch
                            ...
                            onCheckedChange={(value) =>
                              settings.setImageOptimizationAllowGifs(value)
                            }
                          />
                        </div>
                      </CollapsibleContent>
